  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-secondary-900">{t('auth.loginTitle')}</h1>
        <p className="mt-2 text-secondary-600">{t('auth.loginSubtitle')}</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2">
            ...
            <span className="text-sm text-secondary-600">{t('auth.rememberMe')}</span>
          </label>
